        ...
        <div class="content-container clearfix">
            ...
            <aside class="aside">
                ...
                <nav class="menu text-menu first margin-top">
                    <h1>마이페이지</h1>
                    <ul>
                        <li><a href="/admin/index.jsp">관리자홈</a></li>
                        <li><a href="/teacher/index.jsp">선생님페이지</a></li>
                        <li><a href="/student/index.jsp">수강생페이지</a></li>
                    </ul>
                </nav>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                	<c:forTokens var="fileName" items="${n.files}" delims="," varStatus="st">
											...
											<a download href="/upload/${fileName}" style="${style}">${fn:toUpperCase(${fileName})}</a>	<!-- 파일명을 대문자로 표시한다. -->
